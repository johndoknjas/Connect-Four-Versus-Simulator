...
private:
    ...
    double find_revised_player_evaluation(const vector<coordinate_and_value>& info_for_player_amplifying_squares,
...
double position::find_revised_player_evaluation(const vector<coordinate_and_value>& info_for_player_amplifying_squares,
                                                const vector<vector<char>>& player_copy_board, const vector<vector<char>>& opponent_copy_board) const
{
    double temp_evaluation_as_double = 0.0;

    for (const coordinate_and_value& current: info_for_player_amplifying_squares)
    {
                                                ...
                                                vector<vector<char>>& copy_board, vector<coordinate_and_value>& recorder) const
{
    ...
    for (const treasure_spot& space: normal_squares_amplifying_2)
    {
        ...
        if (copy_board[current_square.row][current_square.col] == ' ')
        {
            ...
            if ((is_next_square_in_bounds && copy_board[next_square.row][next_square.col] == ' ' &&
            ...
            {
                // So current_square only turns a 2-in-a-row into a normal 3-in-a-row.
