                                    ...
                                    bool starting_new_game, coordinate& best_move, bool generate_best_move)
{
    ...
    while (/*time_span.count() < thinking_time*/ depth_limit < 9 && !find_duplicate_in_TT(pt).is_evaluation_indisputable &&
           pt->number_of_pieces + depth_limit <= 43 && !stop_signal)
    {
                                                      ...
                                                      coordinate& best_move, bool generate_best_move)
{
           ...
           pt->number_of_pieces + depth_limit <= 43 && !stop_signal)
    {
        ...
        pt = make_unique<position>(is_comp_turnP); // calls constructor 1.
