                                    ...
                                    bool starting_new_game)
{
  ...
  /*  if (thinking_time < 0.000001)
    ...
    while (time_span.count() < thinking_time /*depth_limit < 9*/ && !find_duplicate_in_TT(pt).is_evaluation_indisputable && pt->number_of_pieces + depth_limit <= 43)
    {
